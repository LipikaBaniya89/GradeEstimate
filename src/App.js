      ...
      <Row>
        ...
        <Form className="left-alignment"> 
          ...
          <Form.Group className="mb-3" controlId="formSubject">
              ...
              <Form.Control type="text" placeholder="Add desired courses " ref={subjectRef}/>
            </Form.Group>

            <Form.Group className="mb-3" controlId="formElective">
              <Form.Label> Free Elective </Form.Label>
              <Form.Control className="form-control" type="text" placeholder="Add free elective courses" ref={freeRef}/>
            </Form.Group>
          ...
          <Form.Group className="mb-3" controlId="formGrade">
              ...
              <Form.Control className="form-control" type="text" placeholder="Add free elective courses" ref={gradeRef}/>
            </Form.Group> 

            <Button className="button-size" variant="outline-dark" size ="60px">
              Add
            </Button>
